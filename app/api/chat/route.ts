...
- GIFTER (https://gifter.wilbert.pro/): Zero-login, privacy-first media processing WebApp running completely in your browser. Built with Next.js 16.3, React 19, Tailwind CSS 4, FFmpeg WASM, Tesseract.js, Fabric.js, and more for advanced file conversions, image background removals, and OCR.
...
- Web & AI Stack: Next.js (15, 16.3), React (19), TypeScript, Gemini Vision AI API, Vite, Tailwind CSS (4), HTML/CSS, FFmpeg WASM, Tesseract.js, Fabric.js, LangChain, RAG, IBM WatsonX, Llama 3 70B, HuggingFaceEmbeddings
- Backend & Databases: Node.js, Express, Python, Nginx (Reverse Proxy / API Routing), MongoDB Atlas, MS SQL, MySQL, Stored Procedure, Database Views, Schema Design, Supabase, Cloudinary, Resend SMTP, REST API’s, NoSQL, ChromaDB (Vector Database)
